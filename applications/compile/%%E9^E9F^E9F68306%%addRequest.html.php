<?php /* Smarty version 2.6.26, created on 2012-10-21 17:46:45
         compiled from front/addRequest.html */ ?>
...
request/index.html">校园易物</a></li>
			<li class="cur">发布需求</li>
		</ul>
	</div>
...
request/add/" class="" method="post" id="validateForm">
			<ul>
	          ...
	          <li class="clearfix lists " id="setSelectWrap">
	            <div class="fl">
	            	<span class="fl text_label">需求类别：</span>
		             <select class="fl main_nav" name="column" datatype="*" nullmsg="请选择需求类别！" errormsg="请选择需求类别！">
...
"><?php echo $this->_tpl_vars['allMainColumn'][$this->_sections['nav']['index']]['column_name']; ?>
		             ...
		             <select class="fl sub_nav sub_select" name="nav">
	          ...
	          <li class="clearfix lists " id="brandSelectWrap">
	             <div class="fl">
	             	  <span class="fl text_label">物品品牌：</span>
			             <select class="fl main_nav" name="brand_main" datatype="*" nullmsg="请选择物品品牌！" errormsg="请选择物品品牌！">
...
"><?php echo $this->_tpl_vars['allMainBrand'][$this->_sections['brand']['index']]['brand_name']; ?>
			             ...
			             <select class="fl sub_nav sub_select" name="brand_sub">
	          ...
	          <li class="clearfix lists">
	            <div class="fl">
	            	<span class="fl text_label">新旧程度：</span>
	          		<select name="old_level" class="fl" datatype="*" nullmsg="请选择新旧程度！" errormsg="请选择新旧程度！>
	          ...
	          <li class="clearfix lists">
	            <div class="fl">
	              ...
	              <input type="text" class="text fl" name="title" value="<?php echo $this->_tpl_vars['title_val']; ?>
" datatype="*5-70"  errormsg="标题至少5个字符,最多70个字符！"/>
	          ...
	          <li class="clearfix lists">
	            <div class="fl">
	               ...
	               <input type="text" class="text fl" name="price" value="<?php echo $this->_tpl_vars['price_val']; ?>
	          ...
	          <li class="clearfix lists info_li">
	            <div class="fl">
	            	<span class="fl text_label">补充说明：</span>
			         	<textarea rows="1" cols="1" name="info" ><?php echo $this->_tpl_vars['info_val']; ?>
</textarea>
	          ...
	          <li class="clearfix lists">
	            <div class="fl">
	            	<span class="fl text_label">　联系人：</span>
		             <input type="text" class="text fl" name="contact_name" value="<?php echo $this->_tpl_vars['contact_name_val']; ?>
"  datatype="s2-10"  errormsg="联系人名字至少2个字符,最多10个字符！"/>
	          ...
	          <li class="clearfix lists">
		          <div class="fl">
		             ...
		             <input type="text" class="text fl" name="telephone" value="<?php echo $this->_tpl_vars['telephone_val']; ?>
