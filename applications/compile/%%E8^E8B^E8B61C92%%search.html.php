<?php /* Smarty version 2.6.26, created on 2012-10-21 17:47:00
         compiled from front/search.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'front/search.html', 33, false),array('modifier', 'mb_truncate', 'front/search.html', 114, false),array('modifier', 'replace', 'front/search.html', 114, false),)), $this); ?>
...
search/index/?nav=0&old_level=<?php echo ((is_array($_tmp=@$this->_tpl_vars['cur_oldLevel'])) ? $this->_run_mod_handler('default', true, $_tmp, 0) : smarty_modifier_default($_tmp, 0)); ?>
...
?>
				    <li class=" fl">
							<a href="<?php echo $this->_tpl_vars['front_url']; ?>
search/index/?nav=<?php echo $this->_tpl_vars['allMainColumn'][$this->_sections['nav']['index']]['id']; ?>
...
">
					<li class=" fl">
						<a href="<?php echo $this->_tpl_vars['front_url']; ?>
search/index/?nav=<?php echo ((is_array($_tmp=@$this->_tpl_vars['cur_nav'])) ? $this->_run_mod_handler('default', true, $_tmp, 0) : smarty_modifier_default($_tmp, 0)); ?>
...
.html"><img src="<?php echo $this->_tpl_vars['requestList'][$this->_sections['request']['index']]['thumbs']; ?>
" width="240" height="160" /></a>
		            </div>
		            <div class="text fl">
		            	<h4><a href="<?php echo $this->_tpl_vars['front_url']; ?>
request/requestDetail/<?php echo $this->_tpl_vars['requestList'][$this->_sections['request']['index']]['id']; ?>
.html" class="f44" title="<?php echo $this->_tpl_vars['requestList'][$this->_sections['request']['index']]['title']; ?>
"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['requestList'][$this->_sections['request']['index']]['title'])) ? $this->_run_mod_handler('mb_truncate', true, $_tmp, 38) : smarty_modifier_mb_truncate($_tmp, 38)))) ? $this->_run_mod_handler('replace', true, $_tmp, $this->_tpl_vars['searchKeyWords'], "<span class='high_light'>".($this->_tpl_vars['searchKeyWords'])."</span>") : smarty_modifier_replace($_tmp, $this->_tpl_vars['searchKeyWords'], "<span class='high_light'>".($this->_tpl_vars['searchKeyWords'])."</span>")); ?>
</a></h4>
...
"><?php echo $this->_tpl_vars['requestList'][$this->_sections['request']['index']]['brand_name']; ?>
			            ...
			            <p><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['requestList'][$this->_sections['request']['index']]['info'])) ? $this->_run_mod_handler('mb_truncate', true, $_tmp, 135) : smarty_modifier_mb_truncate($_tmp, 135)))) ? $this->_run_mod_handler('replace', true, $_tmp, $this->_tpl_vars['searchKeyWords'], "<span class='high_light'>".($this->_tpl_vars['searchKeyWords'])."</span>") : smarty_modifier_replace($_tmp, $this->_tpl_vars['searchKeyWords'], "<span class='high_light'>".($this->_tpl_vars['searchKeyWords'])."</span>")); ?>
</p>
		            </div>
		          </li>
		          <?php endfor; endif; ?>
					<?php else: ?>
			            	...
			            	对不起，找不到与您搜索的关键字相匹配的需求，<a href="<?php echo $this->_tpl_vars['front_url']; ?>
