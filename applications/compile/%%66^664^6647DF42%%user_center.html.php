<?php /* Smarty version 2.6.26, created on 2013-01-16 14:02:54
         compiled from front/user_center.html */ ?>
		...
		<div class="right fr wraps">
			...
			<div class="infos">
				...
				<div class="re_list_wrap">
					...
					<?php if ($this->_tpl_vars['auditedRequest'][0]['id']): ?>
						<?php unset($this->_sections['request']);
$this->_sections['request']['name'] = 'request';
$this->_sections['request']['loop'] = is_array($_loop=$this->_tpl_vars['auditedRequest']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
request/requestDetail/<?php echo $this->_tpl_vars['auditedRequest'][$this->_sections['request']['index']]['id']; ?>
.html" class="fl left_thumbs" target="_blank"><img src="<?php echo $this->_tpl_vars['auditedRequest'][$this->_sections['request']['index']]['thumbs']; ?>
" width="60" height="50" alt=""/></a>
									<div class="fl request_title">
										<a href="<?php echo $this->_tpl_vars['front_url']; ?>
request/requestDetail/<?php echo $this->_tpl_vars['auditedRequest'][$this->_sections['request']['index']]['id']; ?>
.html" target="_blank"><?php echo $this->_tpl_vars['auditedRequest'][$this->_sections['request']['index']]['title']; ?>
</a>
										<span><?php echo $this->_tpl_vars['auditedRequest'][$this->_sections['request']['index']]['publish_time']; ?>
</span>
									</div>
								</dt>
								<dd class="fr">
									<a href="<?php echo $this->_tpl_vars['front_url']; ?>
request/update/?id=<?php echo $this->_tpl_vars['auditedRequest'][$this->_sections['request']['index']]['id']; ?>
">编辑</a> | <a href="javascript:if(window.confirm('确认删除吗？')){location.href='#'}">删除</a>
								</dd>
							</dl>
						<?php endfor; endif; ?>
					<?php else: ?>
							<div>您没有显示的需求！<a href="<?php echo $this->_tpl_vars['front_url']; ?>
request/add/" class="high_light">立即发布需求</a></div>
					<?php endif; ?>
					</div>
					<div class="re_list">
					<?php if ($this->_tpl_vars['unAuditedRequest'][0]['id']): ?>
						<?php unset($this->_sections['request']);
$this->_sections['request']['name'] = 'request';
$this->_sections['request']['loop'] = is_array($_loop=$this->_tpl_vars['unAuditedRequest']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['request']['show'] = true;
$this->_sections['request']['max'] = $this->_sections['request']['loop'];
$this->_sections['request']['step'] = 1;
$this->_sections['request']['start'] = $this->_sections['request']['step'] > 0 ? 0 : $this->_sections['request']['loop']-1;
...
?>
							...
							<dl class="clearfix  request_dl">
								<dt class="fl clearfix">
									<a href="<?php echo $this->_tpl_vars['front_url']; ?>
request/requestDetail/<?php echo $this->_tpl_vars['unAuditedRequest'][$this->_sections['request']['index']]['id']; ?>
.html" class="fl left_thumbs" target="_blank"><img src="<?php echo $this->_tpl_vars['unAuditedRequest'][$this->_sections['request']['index']]['thumbs']; ?>
" width="60" height="50" alt=""/></a>
									<div class="fl request_title">
										<a href="<?php echo $this->_tpl_vars['front_url']; ?>
request/requestDetail/<?php echo $this->_tpl_vars['unAuditedRequest'][$this->_sections['request']['index']]['id']; ?>
.html" target="_blank"><?php echo $this->_tpl_vars['unAuditedRequest'][$this->_sections['request']['index']]['title']; ?>
</a>
										<span><?php echo $this->_tpl_vars['unAuditedRequest'][$this->_sections['request']['index']]['publish_time']; ?>
</span>
									</div>
								</dt>
								<dd class="fr">
