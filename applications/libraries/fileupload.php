...
class FileUpload{
	...
	private function setNewName(){
		...
		$this->linkPath='uploads/'.$this->todayDate.'/'.$newName;//设置可以用来在页面中链接图片的路径，即可以放在src中的路径,如uploads/20120716/....
	...
	private  function checkPath(){
		...
		if (!is_dir($this->todayPath) || !is_writeable($this->todayPath)) {
			if (!mkdir($this->todayPath,0777,true)) {
